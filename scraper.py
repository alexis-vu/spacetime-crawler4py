...
def extract_next_links(url, resp):
    ...
    next_links = set()
    if resp.status in range(200, 300) and high_value_page_tester(resp):
...
# def high_value_page(resp_object):
...
#
#     return True if 0.25 < len(set(text.split()))/len(text.split()) < 0.6 else False
